...
namespace ControleContas.Tests
{
    ...
    public class AgenciaTests
    {
        ...
        public void TestarCriacaoAgenciaValida()
        {
            ...
            Agencia agencia = new Agencia(100, "27260-000", "24999999999", banco);

            Assert.AreEqual(100, agencia.Numero);
            Assert.AreEqual("27260-000", agencia.Cep);
        ...
        {
            Banco banco = new Banco("Banco do Brasil", 1);
            Agencia agencia = new Agencia(0, "27260-000", "24999999999", banco);
        }
        ...
        {
            Banco banco = new Banco("Banco do Brasil", 1);
            Agencia agencia = new Agencia(100, "27260-000", "", banco);
        }
        ...
        {
            Agencia agencia = new Agencia(100, "27260-000", "24999999999", null);
        }
    }
}
